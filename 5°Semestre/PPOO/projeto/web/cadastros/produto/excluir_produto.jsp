...
<html>
    ...
    <body>
        ...
        <form action="ControleProduto?acao=Excluir" method="POST">
            ...
            <div>
                <label>Descrição : <b><%= objproduto.getDescricao()%></b></label>
                
            </div>
            <div>
                <label>Quantidade : <b><%= objproduto.getQuantidade()%></b></label>
