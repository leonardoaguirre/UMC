 ...
 * @author Leonardo
 */
public class TitularAdicional implements ITitular{
    private String nome;
    private String cpf;
    private ICartao cartao;
    public final double limite = 500.0;

    public TitularAdicional(ICartao cartao,String nome, String cpf) {
        this.cartao = cartao;
        this.nome=nome;
        this.cpf=cpf;
    }
    ...
    public void sacar(ContaBancaria conta,double valor) {
        System.out.println("Cadastro de titular adicional....");
