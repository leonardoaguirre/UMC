...
public class ControleVeiculo extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            //monta o nome completo e adequaado para a classe
            String nomeDaClasse = "Model."+acao+"VeiculoAction";
            
            //cria uma classe de representacao(meta-programacao)
            Class classeAction = Class.forName(nomeDaClasse);
            
            //insstancia a classe utilizando a factory do objeto class
            commandAction = (ICommand)classeAction.newInstance();
